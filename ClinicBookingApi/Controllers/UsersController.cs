...
namespace ClinicBookingApi.Controllers
{
	...
	public class UsersController : ControllerBase
	{
		...
		private void EnsureCanViewUserCore(bool isOwnProfile)
		{
			...
			// Self-view: Doctors και Patients μπορούν να δουν τον εαυτό τους
			if (isOwnProfile && (currentUserRole == "DOCTOR" || currentUserRole == "PATIENT"))
			{
				return;
			}

			// Other-view: χρειάζεσαι VIEW_USER capability
